    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-neutral-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-1">有効期限</label>
      ...
      <div className="bg-white rounded-lg border border-neutral-200 p-6">
        ...
        <div className="mt-6 pt-4 border-t border-neutral-100 space-y-2 text-sm">
          ...
          <div className="flex justify-between pt-2 border-t border-neutral-200 font-bold text-base">
            <span>合計</span>
            <span className="font-mono text-brand-primary">¥{fmt(total)}</span>
          </div>
        </div>
      </div>
      ...
      {/* 備考 */}
      <div className="bg-white rounded-lg border border-neutral-200 p-6">
        <label className="block text-sm font-medium text-neutral-700 mb-1">備考</label>
        <textarea value={note} onChange={e => setNote(e.target.value)} rows={3}
          className="w-full border border-neutral-200 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary" placeholder="支払条件、納期など" />
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button type="button" onClick={() => router.push('/estimates')} className="text-sm text-neutral-500 hover:text-neutral-800 px-4 py-2 rounded-md border border-neutral-200 hover:bg-neutral-50 cursor-pointer">
          キャンセル
        </button>
      </div>
    </form>
