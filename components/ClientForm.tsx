...
export default function ClientForm({ initial }: Props) {
  ...
  return (
    <form action={action} className="bg-white rounded-xl border border-slate-200 p-6 max-w-lg space-y-5">
      <div>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <a href="/clients" className="text-sm text-slate-500 hover:text-slate-800 px-4 py-2 rounded-lg border border-slate-200 hover:bg-slate-50">
          キャンセル
        </a>
      </div>
    </form>
